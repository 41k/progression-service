...
public class FunctionalTestData {
	...
	private static final String USER_STATE_WITH_ACTIVE_CONFIGURATION = getFileContent("db/state/user-state-with-active-configuration.json");
	...
	public static UserStateDocument userStateWithInactiveConfiguration() {
		return userState(USER_STATE_WITH_INACTIVE_CONFIGURATION, 0);
	}

	public static UserStateDocument userStateWithActiveConfiguration() {
		return userState(USER_STATE_WITH_ACTIVE_CONFIGURATION, 2);
	}
