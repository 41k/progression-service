...
import static functional.FunctionalTestData.SOURCE_1_EVENT_FOR_TOTAL_PROGRESSION;
import static functional.FunctionalTestData.SOURCE_1_TOTAL_PROGRESSION_REWARD_MESSAGE;
...
public class Source1EventTotalProgressionHandlerFlowTest extends FunctionalTest {
	...
	void shouldHandleProgressionSuccessfully() {
		...
		// when
		sendKafkaMessage(source1Topic, SOURCE_1_EVENT_FOR_TOTAL_PROGRESSION);
		sendKafkaMessage(source1Topic, SOURCE_1_EVENT_FOR_TOTAL_PROGRESSION);
		sendKafkaMessage(source1Topic, SOURCE_1_EVENT_FOR_TOTAL_PROGRESSION);
		sendKafkaMessage(source1Topic, SOURCE_1_EVENT_FOR_TOTAL_PROGRESSION);
		...
		// and
		rewardsTopicConsumer.assertMessageSent(Pair.of(USER_ID, SOURCE_1_TOTAL_PROGRESSION_REWARD_MESSAGE));
	}
