...
public class UserStateServiceTest {
	...
	@Mock
	private ProgressionsConfigurationService configurationService;
	@Mock
	...
	void shouldUpdateUserState_withLatestConfigurationUpdatesSync() {
		...
		var expectedUpdatedUserState = USER_STATE.toBuilder()
				.configuration(UserProgressionsConfiguration.builder()
						.id(CONFIGURATION_ID)
		...
		when(configurationService.getCachedActiveConfigurationById(CONFIGURATION_ID)).thenReturn(SEGMENTED_PROGRESSIONS_CONFIGURATION);
